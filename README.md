...
| 항목 | 내용 |
|---|---|
| 평가영역 | **정렬 알고리즘 설계** (활동명: 비선형구조-알고리즘 연결고리 발견하기) |
| 시기 / 배점 | 8월 4주 (8/24~8/28) · 100점 만점 (반영비율 35%) |
| 성취기준 | `[자료구조03-01]` `[자료구조03-02]` `[자료구조04-02]` |
| 교육과정 | 2015 개정 교육과정 (3단계 평정) |

### 학기 평가 반영비율

| 구분 | 영역 | 시기 | 반영비율 | 서술·논술형 |
|---|---|---|---|---|
| 수행평가 1 | 정렬 알고리즘 설계 | 8월 4주 | **35%** | 0% |
| 수행평가 2 | 탐색 알고리즘 설계 | 9월 | **35%** | 0% |
| 정기고사 | 1차 정기고사 (선택형·단답형) | 10/2, 10/6~10/8 | **30%** | 0% |
| | | | **100%** | **0%** |
